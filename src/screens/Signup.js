          ...
          <div class="px-6 lg:px-20 py-12 lg:py-24 bg-clay rounded-lg">
            <form action="#" onSubmit={handlesignup}>
              ...
              <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
                <span class="inline-block pr-3 py-2 border-r border-gray-50">
                  ...
                  <svg class="w-5 h-5" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10 0.5C7.23858 0.5 5 2.73858 5 5.5C5 8.26142 7.23858 10.5 10 10.5C12.7614 10.5 15 8.26142 15 5.5C15 2.73858 12.7614 0.5 10 0.5ZM6 5.5C6 3.567 7.567 2 9.5 2C11.433 2 13 3.567 13 5.5C13 7.433 11.433 9 9.5 9C7.567 9 6 7.433 6 5.5Z" fill="black"></path>
                    <path d="M1.5 18.5V16.5C1.5 14.57 3.07 13 5 13H15C16.93 13 18.5 14.57 18.5 16.5V18.5C18.5 18.7761 18.2761 19 18 19H2C1.72386 19 1.5 18.7761 1.5 18.5Z" fill="black"></path>
                  </svg>

                </span>
                <input class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="Text" placeholder="Full Name"/>
              </div>
              ...
              <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
                ...
                <input class="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="email" placeholder="example@habib.me"/>
              </div>
              <div class="flex items-center pl-6 mb-3 bg-white rounded-full">
                <span class="inline-block pr-3 py-2 border-r border-gray-50">
              ...
              <div className="p-6 bg-white rounded shadow-md"> */}
                ...
                <div className="flex flex-col items-start ">
                  <label className="-mt-2 ml-2 text-m font-bold text-gray-200 mb-2">Choose Your Status:</label>
                  <div className="flex space-x-4 ml-2">
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-2"
                      />
                      <label htmlFor="student" className="-mt-1 text-sm text-gray-200">Student</label>
                    </div>
                    <div className="flex items-center">
                      <input
                        type="radio"
                        ...
                        className="mr-2"
                      />
                      <label htmlFor="alumni" className="-mt-0 text-sm text-gray-200">Alumni</label>
                    </div>
                  </div>
                </div>
                <br />
              ...
              <div class="inline-flex mb-10">
                ...
                <p class="-mt-2 text-sm text-gray-200">By singning up, you agree to our <a class="text-white" href="google.com">Terms, Data Policy</a>and <a class="text-white" href="google.com">Cookies.</a></p>
              </div>
