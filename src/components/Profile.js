...
export default function Example() {
    ...
    return (
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100 overflow-hidden 2xl:py-40">
            <div class="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-gray-700 bg-opacity-20 shadow-2xl rounded-xl
            relative z-10">
